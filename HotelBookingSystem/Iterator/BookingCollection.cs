...
namespace HotelBookingSystem.Iterator
{
     ...
     // ?i întoarce la cerere iteratoare distincte, în mod anonim.
     // DE CE R?SPUNDE: O singur? clas? BookingCollection poate întoarce 6 tipuri 
     // separate de "scannere" ale listei. De aici rezult? Single Responsibility: colec?ia 
     // pur ?i simplu de?ine elementele ?i întoarce instrumentele ("Create....Iterator") ce 
     ...
     // pe ecran/creeaz? texte pentru rapoarte, în func?ie de rezerv?rile procesate.  
