...
namespace HotelBookingSystem.Memento
{
     ...
     // Clasa care detine cutia/stiva cu toate stadiile salvate prin mementourile noastre snapshot.
     // Scopul este exclusiv de a tine amintiri fara a stii macar o singura data ce este sub campurile "internal".
     // Nu citeste memento-ul ci executa pop sau push pe obiect complet.
     // --------------------------------------------------------------------------
     public class BookingFormHistory
     {
